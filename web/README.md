...
The Skater League app comes with end-to-end tests, again written in [Jasmine][jasmine]. These tests
...
In addition, since Protractor is built upon WebDriver we need to install this.  The Skater League
...
Previously we recommended that you merge in changes to Skater League into your own fork of the project.
...
The Skater League project supports loading the framework and application scripts asynchronously.  The
...
The Skater League project comes preconfigured with a local development webserver.  It is a node.js
...
to your repository and execute scripts such as building the app or running tests. The Skater League
