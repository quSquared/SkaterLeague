...
export class FlexDirective extends BaseFxDirective implements OnInit, OnChanges, OnDestroy {
  ...
  @Input('qu-flex')       set flex(val)     { this._cacheInput("flex", val); }
  @Input('qu-shrink')     set shrink(val)   { this._cacheInput("shrink", val); }
  @Input('qu-grow')       set grow(val)     { this._cacheInput("grow", val); }
  
  @Input('qu-flex.xs')    set flexXs(val)   { this._cacheInput('flexXs', val); }
  @Input('qu-flex.gt-xs') set flexGtXs(val) { this._cacheInput('flexGtXs', val); };
  @Input('qu-flex.sm')    set flexSm(val)   { this._cacheInput('flexSm', val); };
  @Input('qu-flex.gt-sm') set flexGtSm(val) { this._cacheInput('flexGtSm', val); };
  @Input('qu-flex.md')    set flexMd(val)   { this._cacheInput('flexMd', val); };
  @Input('qu-flex.gt-md') set flexGtMd(val) { this._cacheInput('flexGtMd', val); };
  @Input('qu-flex.lg')    set flexLg(val)   { this._cacheInput('flexLg', val); };
  @Input('qu-flex.gt-lg') set flexGtLg(val) { this._cacheInput('flexGtLg', val); };
  @Input('qu-flex.xl')    set flexXl(val)   { this._cacheInput('flexXl', val); };
  ...
  /**
   * If the used the short-form `qu-flex="1 0 37%"`, then parse the parts
   */
