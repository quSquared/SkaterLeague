...
export class HideDirective extends BaseFxDirective implements OnInit, OnChanges, OnDestroy {
  ...
  @Input('qu-hide')       set hide(val)     { this._cacheInput("hide", val); }
  @Input('qu-hide.xs')    set hideXs(val)   { this._cacheInput('hideXs', val); }
  @Input('qu-hide.gt-xs') set hideGtXs(val) { this._cacheInput('hideGtXs', val); };
  @Input('qu-hide.sm')    set hideSm(val)   { this._cacheInput('hideSm', val); };
  @Input('qu-hide.gt-sm') set hideGtSm(val) { this._cacheInput('hideGtSm', val); };
  @Input('qu-hide.md')    set hideMd(val)   { this._cacheInput('hideMd', val); };
  @Input('qu-hide.gt-md') set hideGtMd(val) { this._cacheInput('hideGtMd', val); };
  @Input('qu-hide.lg')    set hideLg(val)   { this._cacheInput('hideLg', val); };
  @Input('qu-hide.gt-lg') set hideGtLg(val) { this._cacheInput('hideGtLg', val); };
  @Input('qu-hide.xl')    set hideXl(val)   { this._cacheInput('hideXl', val); };
   ...
   * Default to use the non-responsive Input value ('qu-hide')
